...
<svelte:head>
    <title>{productName} - deltacv</title>
    <meta
        name="description"
        content="{productName} is a desktop simulator for EasyOpenCV — develop, test, and tune your FTC robotics vision pipelines directly on your computer without touching the robot."
    />
</svelte:head>
                ...
                <SplideSlide class="pb-12 text-center">
                    ...
                    >
                        <MediaElement
                            ...
                            alt="{productName} AprilTag detection"
                    ...
                    <p class="mt-4 text-sm text-gray-400 max-w-lg mx-auto">
                        Perform AprilTag detection with {productName}
                    </p>
                </SplideSlide>
        ...
        <section class="my-24">
            ...
            >
                ...
                <Feature
                    icon={Zap}
                    url="/visiongraph"
                    title="Integrated VisionGraph Node Editor"
                    desc="Prototype algorithms visually with a node editor. Included in {productName}."
                    color="rose"
    ...
    >
        ...
        >
            <div class="text-center flex flex-col items-center mb-16">
                ...
                >
                    {productName} relies on OpenCV's native libraries, making it
                    performant but platform-specific. Check below to ensure your
                    system is supported.
                </p>
